                            ...
                            <Row>
                                <Col md={6}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="text" onChange={e => setFirstName(e.target.value)} value={user.firstName} className="rounded p-4" />
                                    </Form.Group>
                                </Col>
                                <Col md={6}>
                                    <Form.Group>
                                        <Form.Label>Last Name</Form.Label>
                                        <Form.Control type="text" onChange={e => setLastName(e.target.value)} value={user.lastName} className="rounded p-4" />
                                    </Form.Group>
                                </Col>
                            </Row>
                            <Row>
                                <Col md={6}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="email" onChange={e => setEmail(e.target.value)} value={user.email} className="rounded p-4" />
                                    </Form.Group>
                                </Col>
                                <Col md={6}>
                                    ...
                                    <InputGroup>
                                        ...
                                        <Form.Control type="tel" onChange={e => setPhoneNumber(e.target.value)} value={user.phone} className="rounded p-4" />
                                    </InputGroup>
                                </Col>
                            </Row>
                        </Form>
            ...
            <Container>
                <Row>
                    <Col md={4}>
                        <Card style={{ borderRadius: "1rem", color: "#14142B" }} className="border-0">
                            <Card.Header style={{ borderTopLeftRadius: "1rem", borderTopRightRadius: "1rem" }} className="bg-white p-5">
                                ...
                                <div className="text-center">
                                    <img src={`${process.env.REACT_APP_API_URL}profile/${user.picture}`} width="120" alt="user" className="img-fluid rounded-circle"/>
                    ...
                    <Col md={8} className="mt-4 mt-md-0">
                        ...
                        {
                           selectedPage === 'account-settings' ? <AccountSettings/> : <OrderHistory/>
                        }
                    </Col>
                </Row>
            </Container>
