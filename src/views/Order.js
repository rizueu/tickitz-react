...
import { selectSeat, setTicketCount, setTotalPayment, removeSeat, setPersonalInfo, setPaymentMethod, setMessage } from '../redux/actions/order'
...
const Order = () => {
    ...
    if( method === 'booking' ) {
                ...
                <Layout>
                    <Col md={8}>
                                                            ...
                                                            <Fragment key={ colIndex }>
                                                                {
                                                                    (soldSeat.some((item) => item === `${row}${col}`)) ? (
                                                                        <label>
                                                                            <input type="checkbox" name="" id={row + '-' + col} value={row + col} />
                                                                            <div className="checkmark"></div>
                                                                        </label>
                                                                        ) : (!seats.some((item) => item === `${row}${col}`)) ? (
                                                                        <label>
                                                                            <input type="checkbox" name="" id={row + '-' + col} value={row + col} onChange={ selectedSeats } />
                                                                            <div className="checkmark"></div>
                                                                        </label>
                                                                        ) : (
                                                                        <label>
                                                                            <input type="checkbox" name="" id={row + '-' + col} value={row + col} onChange={ selectedSeats } defaultChecked />
                                                                            <div className="checkmark"></div>
                                                                        </label>
                                                                    )
                                                                }
                                                ...
                                                { seatNumRight.map((col, colIndex) => (
                                                    ...
                                                    {(row === 'F' && Number(col) === 10) ? (
                                                        <Fragment>
                                                        {
                                                            (soldSeat.some((item) => item === `${row}${col}`)) ? (
                                                                <label>
                                                                    <input type="checkbox" name="" id={row + '-' + col} value={`${row + col},${row + (Number(col) + 1)}`} />
                                                                    <div className="checkmark love-nest"></div>
                                                                </label>
                                                                ) : (!seats.some((item) => item === `${row}${col}`)) ? (
                                                                <label>
                                                                    <input type="checkbox" name="" id={row + '-' + col} value={`${row + col},${row + (Number(col) + 1)}`} onChange={ selectedSeats } />
                                                                    <div className="checkmark love-nest"></div>
                                                                </label>
                                                                ) : (
                                                                <label>
                                                                    <input type="checkbox" name="" id={row + '-' + col} value={`${row + col},${row + (Number(col) + 1)}`} onChange={ selectedSeats } defaultChecked />
                                                                    <div className="checkmark love-nest"></div>
                                                                </label>
                                                            )
                                                        }
                        ...
                        <div className="row mt-4 d-none d-md-flex">
                            <div className="col">
                                <button onClick={ chooseMovie } style={{ fontSize: "15px" }} className="btn btn-outline-primary rounded-3 py-3 w-100">Choose your movie</button>
                            </div>
                            <div className="col">
                        ...
                        <Card style={{ borderRadius: "1rem" }} className="border-0">
                            <Card.Header style={{ borderTopLeftRadius: "1rem", borderTopRightRadius: "1rem" }} className="bg-white py-4">
                                ...
                                <div className="d-flex justify-content-between mt-3">
                                    ...
                                    <small className="font-weight-bold">{results.movieTitle}</small>
                                </div>
                                <div className="d-flex justify-content-between mt-3">
                                ...
                                <div className="d-flex justify-content-between mt-3">
                                    ...
                                    <small className="font-weight-bold">Rp. {results.pricePerSeat}</small>
                                </div>
                                <div className="d-flex justify-content-between mt-3">
                                    <small className="text-muted">Seat choosed</small>
                                    <small className="font-weight-bold">{results.seats.join(', ')}</small>
                                </div>
                            </Card.Header>
                            <Card.Body>
                                <div className="d-flex justify-content-between">
                                    <span className="font-weight-bold">Total Payment</span>
                                    <span className="text-primary font-weight-bold">Rp. {results.totalPayment}</span>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
        ...
        const getTicket = () => {
            ...
            } else if(results.phone.match(/[a-z]/gi) || results.phone.match(/[^0-9]/gi)) {
            ...
            <Fragment>
                ...
                <Layout>
                        ...
                        <Card style={{ borderRadius: "1rem" }} className="border-0">
                            <Card.Body className="p-4">
                                ...
                                <div className="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <span className="font-weight-bold">Rp. {results.totalPayment}</span>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
                            ...
                            <Card.Body className="p-4">
                                <form>
                                    <div className="mb-3">
                                        ...
                                        <input type="text" name="fullname" id="fullname" onChange={e => handleInput(e, 'fullName')} className="form-control rounded-3 px-4 py-2"/>
                                    </div>
                                    <div className="mb-3">
                                        <label for="email" className="form-label text-muted">Email</label>
                                        <input type="email" name="email" id="email" onChange={e => handleInput(e, 'email')} className="form-control rounded-3 px-4 py-2"/>
                                    </div>
                                    ...
                                    <div className="input-group mb-4">
                                        ...
                                        <input type="tel" name="phone" id="phone" onChange={e => handleInput(e, 'phone')} className="form-control rounded-end px-3 py-2"/>
                                    </div>
                                    {
                                        results.message ? (
                    ...
                    <div style={{ borderRadius: "1rem" }} className="card border-0">
                        <div className="card-body p-4">
                            ...
                            <div className="d-flex flex-wrap align-items-center text-center mb-4">
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('Google Pay'))}>
                                ...
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('Visa'))}>
                                ...
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('GoPay'))}>
                                ...
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('PayPal'))}>
                                ...
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('Dana'))}>
                                    <img src={logoDana} width="90" alt="dana-payment-method"/>           
                                </button>
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('BCA'))}>
                                ...
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('BRI'))}>
                                ...
                                <button className="btn btn-payment-method" onClick={() => dispatch(setPaymentMethod('OvO'))}>
                    ...
                    <div className="row mt-4 d-none d-md-flex">
                        ...
                        <div className="col">
                            <button onClick={getTicket} style={{ fontSize: "15px" }} className="btn btn-primary rounded-3 py-3 w-100">Pay your order</button>
                        </div>
                    </div>
                </div>
                </Layout>
