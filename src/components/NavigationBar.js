          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto mb-2 mb-lg-0">
              <Form inline className="d-block d-lg-none position-relative">
                ...
                <FormControl
                  className="w-100 py-4 pl-5"
                  type="text"
                  placeholder="Search.."
                />
              </Form>
              <NavDropdown
                className="d-block d-lg-none text-center py-2"
                title="Location"
            ...
            <Nav className="ml-auto">
              <NavDropdown
                className="d-none d-lg-block pr-4"
                title="Location"
                id="basic-nav-dropdown"
              >
                <NavDropdown.Item href="#">Surabaya</NavDropdown.Item>
              ...
              <Nav.Item>
                {token !== null ? (
                  ...
                  <Link
                    className="btn btn-primary btn-block py-3 py-lg-2 px-4"
                    to="/auth/register"
                  >
                    Sign Up
                  </Link>
