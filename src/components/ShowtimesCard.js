...
const ShowtimesCard = (props) => {
  ...
  function getTimes() {
    axios
      .get(`${process.env.REACT_APP_API_URL}api/v1/times`)
      .then((response) => {
  ...
  return (
    <Col lg={4} className="mt-4">
      <Card
        ...
        className="pb-3 border-0 showtimes-card"
      >
        ...
        <Card.Body className="px-4">
                  ...
                  <Fragment key={index}>
                    <button
                      onClick={(e) => {
                        ...
                        axios
                          .get(
                            `${process.env.REACT_APP_API_URL}api/v1/times/id?showTime=${timesElement.showTime}`
                          )
                          .then((response) => {
                        ...
                        axios
                          .get(
                            `${process.env.REACT_APP_API_URL}api/v1/selected-showtime?showTimeDate=${props.showTimeDate}&timeId=${timeId}&cinemaId=${props.cinemaId}&movieId=${props.movieId}`
                          )
                          .then((response) =>
                            setShowTimeId(response.data.results.showTimeId)
                          );
                      }}
          ...
          <div className="d-flex justify-content-between">
            {showTimeId !== null ? (
              ...
              <Button className="btn btn-primary w-100 mr-3 disabled">
                Book now
              </Button>
            )}
